...
public class DumperThread extends Thread {
    private boolean internalProfiling;
    ...
    public DumperThread (boolean profiling, int sleep, boolean jmx, int jmxport) {
        internalProfiling = profiling;
        sleepSeconds = sleep;
        enableJMX = jmx;
        port = jmxport;
    ...
    public void run () {
        ...
        // getMemoryPoolMXBeans should be called more that once if more pools are created...
        List<MemoryPoolMXBean> memoryPoolMXBeans = ManagementFactory.getMemoryPoolMXBeans();

        FMLLog.bigWarning("You have installed TroubleshootingMod (for debugging purposes). Your log will be filled with thread dumps and memory information. Do not use this mod in production environment!!");
